...
public class PeriodContractFulfillmentChart {
    ...
    @Autowired
    public PeriodContractFulfillmentChart(StatisticsService statisticsService, GraphKeyValueRepository graphKeyValueRepository, UserService userService, ExpenseRepository expenseRepository, CountEmployeesJob countEmployeesJob) {
