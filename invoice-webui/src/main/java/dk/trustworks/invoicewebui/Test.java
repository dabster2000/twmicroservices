...
/*
    public static void main(String[] args) throws Exception {
        ...
        final String filenameTrain = Test.class.getResource("/classification/linear_data_train.csv").getFile();
        final String filenameTest = Test.class.getResource("/classification/linear_data_eval.csv").getFile();
